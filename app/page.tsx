    ...
    <>
      ...
      {activeTab === 'home' ? (
        ...
        <div className="max-w-5xl mx-auto">
          ...
          {/* About Section */}
          <div className="rounded-3xl p-8 max-w-3xl mx-auto mb-12" style={{ background: '#F5F1E8', border: '1px solid #E8E6E1' }}>
          ...
          <div className="max-w-4xl mx-auto mb-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="rounded-2xl p-4 text-center transition-all duration-300 hover:shadow-md" style={{ background: '#F5F1E8', border: '1px solid #E8E6E1' }}>
                <div className="flex justify-center mb-3">
                  <svg className="w-10 h-10" viewBox="0 0 24 24" fill="none" stroke="#8B9A7E" strokeWidth="1.5">
              ...
              <div className="rounded-2xl p-4 text-center transition-all duration-300 hover:shadow-md" style={{ background: '#F5F1E8', border: '1px solid #E8E6E1' }}>
                <div className="flex justify-center items-center mb-3">
                  <svg className="w-10 h-10" viewBox="2 1 12 14" fill="#8B9A7E">
              ...
              <div className="rounded-2xl p-4 text-center transition-all duration-300 hover:shadow-md" style={{ background: '#F5F1E8', border: '1px solid #E8E6E1' }}>
                <div className="flex justify-center mb-3">
                  <svg className="w-10 h-10" viewBox="0 0 512 512" fill="#8B9A7E">
              ...
              <div className="rounded-2xl p-4 text-center transition-all duration-300 hover:shadow-md" style={{ background: '#F5F1E8', border: '1px solid #E8E6E1' }}>
                <div className="flex justify-center mb-3">
                  <svg className="w-10 h-10" viewBox="0 0 24 24" fill="#8B9A7E">
                ...
                <div className="text-sm font-medium" style={{ color: '#2B2B2B' }}>Geometric Deep Learning</div>
              </div>
            </div>
          </div>
          ...
          {/* Scroll Indicator */}
          <div
            className="absolute bottom-4 left-1/2 transform -translate-x-1/2 transition-opacity duration-1000"
            style={{ opacity: showScrollIndicator ? 0.6 : 0, pointerEvents: showScrollIndicator ? 'auto' : 'none' }}
            onMouseEnter={(e) => showScrollIndicator && (e.currentTarget.style.opacity = '1')}
            onMouseLeave={(e) => showScrollIndicator && (e.currentTarget.style.opacity = '0.6')}
          >
            <svg
              className="w-8 h-8"
              fill="none"
