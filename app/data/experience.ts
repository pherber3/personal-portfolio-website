...
export const experiences: Experience[] = [
  {
    ...
    details: [
      ...
      "**Batch Transcription & Domain Language Model:** Replaced WhisperX with customized Parakeet for offline call processing. Trained 6-gram KenLM domain language model on curated call transcripts with shallow fusion and GPU phrase boosting, reducing WER from 18.3% to 16.2%. Built custom evaluation framework (content WER, rare word WER, BERTScore, domain keyword accuracy). Achieved 91% agreement with human QA graders, matching the enterprise model. 73% faster transcription, 275x lower cost",
